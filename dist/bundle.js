...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dashboardContainer = __webpack_require__(191);

	var _dashboardReducer = __webpack_require__(194);

	var _dashboardReducer2 = _interopRequireDefault(_dashboardReducer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var dummyTodos = _immutable2.default.fromJS([{ id: 0, isDone: true, text: 'make components' }, { id: 1, isDone: false, text: 'design actions' }, { id: 2, isDone: false, text: 'implement reducer' }, { id: 3, isDone: false, text: 'connect components' }]);

	var store = (0, _redux.createStore)(_dashboardReducer2.default, dummyTodos);

	(0, _reactDom.render)(_react2.default.createElement(
	  _reactRedux.Provider,
	  { store: store },
	  _react2.default.createElement(_dashboardContainer.TodoList, null)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _testComponents = __webpack_require__(192);

	var components = _interopRequireWildcard(_testComponents);

	var _testActions = __webpack_require__(193);
	...
	var TodoList = exports.TodoList = (0, _reactRedux.connect)(function mapStateToProps(state) {
	  ...
	  return {
	    addTodo: function addTodo(text) {
	      return dispatch((0, _testActions.addTodo)(text));
	    },
	    toggleTodo: function toggleTodo(id) {
	      return dispatch((0, _testActions.toggleTodo)(id));
	    }
	  };
	})(components.TodoList);
