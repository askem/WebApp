...
class AdPreview extends React.Component {
	...
	render() {
		...
		const audienceNetworkInterstital = (
		...
		const previewArray = new Map();
		previewArray.set('desktop_news_feed', desktopNewsFeed);
		previewArray.set('mobile_news_feed', mobileNewsFeed);
		previewArray.set('feature_phone', featurePhone);
		previewArray.set('instant_articles', instantArticles);
		previewArray.set('desktop_right_column', desktopRightColumn);
		previewArray.set('audience_network_banner', audienceNetworkBanner);
		previewArray.set('audience_network_interstitial', audienceNetworkInterstital);
		previewArray.set('audience_network_native', audienceNetworkNative);

		const preview = previewArray.get(this.props.adType);
